...
uint8_t *
hmac_pad(uint8_t *input, size_t size, size_t blockSize)
{
...
uint8_t *
hmac(const void *msg, size_t size, const void *K, size_t keySize, void *(*H)(const void *, size_t), size_t blockSize, size_t outputLength)
{
